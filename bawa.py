# Decompile by - gurmeet singh (Bawa)
# Time Succes decompile : 2022-10-12 18:42:56.938037
...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open https://bit.ly/3VlSMaj")
...
class __xxx__:
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Bawa-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Bawa_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Bawa_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      Dont Forget 😊 \033[1;37m")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/profile.php?id=100000261778248")
